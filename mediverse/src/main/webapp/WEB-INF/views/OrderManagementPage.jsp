...
<body>
    ...
    <div class="container">
        ...
        <div class="module-card">
            ...
            <a href="/admin/addOrderPage">Go to Add Order</a>
        </div>
        ...
        <div class="module-card">
            ...
            <a href="/admin/updateOrderPage">Go to Update Order</a>
        </div>
        ...
        <div class="module-card">
            ...
            <a href="/admin/deleteOrderPage">Go to Delete Order</a>
        </div>
        ...
        <div class="module-card">
            ...
            <a href="/admin/getAllOrderPage">Go to View Orders</a>
        </div>

...
<head>
    ...
    <title>Mediverse Admin Dashboard - Update Customer</title>
    <style>
        /* Global styles */
        body {
        ...
        input[type="text"], input[type="email"], input[type="tel"], input[type="checkbox"], input[type="number"] {
            width: 100%;
            padding: 10px;
            margin-top: 5px;
...
<body>
    ...
    <!-- Header Section -->
    <div class="header">
        <h1>Mediverse Admin Dashboard - Update Customer</h1>
    </div>

...
<head>
    ...
    <title>Mediverse Admin Dashboard - Update Insurance Claim</title>
    <style>
        /* Global styles */
        body {
...
<body>
    ...
    <!-- Header Section -->
    <div class="header">
        <h1>Mediverse Admin Dashboard - Update Insurance Claim</h1>
    </div>

    <!-- Main Content Section -->
    <div class="container">
        <h2>Update Existing Insurance Claim</h2>
        <form action="./updateInsuranceClaim" method="POST">
            ...
            <!-- Submit Button -->
            <div class="form-group">
                <input type="submit" value="Update Insurance Claim">
            </div>
        </form>
    </div>

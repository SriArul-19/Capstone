...
public class CustomerController 
{
 ...
 // Request Cancellation Page
    ...
    public String showCancellationRequestPage(@PathVariable Long orderId, HttpSession session, Model model) {
        Customer customer = (Customer) session.getAttribute("loggedInCustomer");
        ...
        return "CancellationRequestPage"; // Page to ask for the cancellation reason
    }

    // Submit Cancellation Request
    @PostMapping("/submitCancelRequest/{orderId}")
    public String submitCancellationRequest(@PathVariable Long orderId,
                                            @RequestParam String cancellationReason, HttpSession session, Model model) {
        ...
        cancellationRequest.setRequestDate(LocalDate.now());

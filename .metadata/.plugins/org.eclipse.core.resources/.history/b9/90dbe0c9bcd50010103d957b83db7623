...
<head>
    ...
    <title>Mediverse Admin Dashboard - Order Management</title>
    <style>
        /* Global styles */
        body {
...
<body>
    ...
    <!-- Header Section -->
    <div class="header">
        <h1>Welcome to Mediverse Admin Dashboard - Order Management</h1>
    ...
    <div class="container">
        ...
        <div class="module-card">
            <h3>Add Order</h3>
            <p>Click to add a new order to the system.</p>
            <a href="/admin/order/add">Go to Add Order</a>
        </div>

        <!-- Update Order Card -->
        <div class="module-card">
            <h3>Update Order</h3>
            <p>Click to update order details.</p>
            <a href="/admin/order/update">Go to Update Order</a>
        </div>

        <!-- Delete Order Card -->
        <div class="module-card">
            <h3>Delete Order</h3>
            <p>Click to delete an existing order.</p>
            <a href="/admin/order/delete">Go to Delete Order</a>
        </div>

        <!-- View All Orders Card -->
        <div class="module-card">
            <h3>View All Orders</h3>
            <p>Click to view the list of all orders.</p>
            <a href="/admin/orders">Go to View Orders</a>
        </div>

        <!-- Find Order by ID Card -->
        <div class="module-card">
            <h3>Find Order by ID</h3>
            <p>Search for an order using its unique ID.</p>
            <a href="/admin/order/findById">Go to Find Order by ID</a>
        </div>

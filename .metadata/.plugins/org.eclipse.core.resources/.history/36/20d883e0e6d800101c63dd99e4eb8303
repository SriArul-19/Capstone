...
<head>
    ...
    <title>Mediverse Admin Dashboard - Insurance Claim Management</title>
    <style>
        /* Global styles */
        body {
...
<body>
    ...
    <!-- Header Section -->
    <div class="header">
        <h1>Welcome to Mediverse Admin Dashboard - Insurance Claim Management</h1>
